...
$e2g_lang['spanish'] = array (
	'_thumb_err' => 'No se puede crear la carpeta &quot;_thumbnails&quot;',
	...
	'alias' => 'Alias',
	'all' => 'Todos',
	'all_add_error' => 'Could not add all',
	'and' => 'y',
	'approve' => 'Aprobar',
	'approve_not' => 'Desaprobar',
	'approved' => 'Aprobado',
	'approved_not' => 'No aprobados',
	'archive' => 'Archivo zip',
	'asc' => 'asc',
	'author' => 'Autor',
	'auto' => 'Auto',
	...
	'bottom' => 'fondo',
	'btn_field_add' => 'Subir más',
	'btn_field_add_plugin' => 'Añadir más plugins',
	'btn_field_add_slideshow' => 'Agregue más diapositivas',
	'cache_clean' => 'Caché ha sido borrado',
	'cache_clean_err' => 'Ha habido un error al intentar de limpiar el caché',
	'cancel' => 'Cancelar',
	'captcha_desc' => 'Si no tienes las llaves de la API, consígalo aquí: &lt;a href=&quot;http://recaptcha.net/&quot; target=&quot;_blank&quot;&gt;http://recaptcha.net/&lt;/a&gt;',
	'cat_id' => 'Identificador de carpeta',
	'cat_name_len' => 'longitud máxima del nombre de la carpeta',
	'cat_name_len_cfg_desc' => 'Longitud máxima del nombre de la carpeta',
	'cat_thumb_order_cfg' => 'Orden de miniaturas de la carpeta',
	'cat_thumb_order_cfg_desc' => 'Método de ordenación de miniaturas de carpeta',
	'center' => 'centrar',
	'cfg_back_class' => 'Clase de botones de atrás',
	'cfg_crumbs_classCurrent' => 'Clase actual de migas',
	'cfg_pagenum_class' => 'Clase de paginación',
	'char_bad' => 'Caracteres invalidos para el sistema de archivo',
	'char_limitation' => '&lt;p&gt;Por favor, use &lt;strong&gt;letras comunes en latín &lt;/strong&gt; de los nombres de de los archivo contenidos dentro el ZIP, o el sistema de archivos se encuentran errores durante la subida. &lt;br /&gt;Para algunas codificaciones, UTF-8 será ignorado o traducida a la más cercana carácter..&lt;/p&gt;',
	'charset' => 'UTF-8',
	'chmod_enabled_cfg' => 'Enable the auto set permission by the script',
	'chmod_err' => 'No se puede cambiar el permiso',
	...
	'clean' => 'Limpiar',
	'clean_cache' => 'Borrar la caché',
	'click_edit' => 'Haga clic para editar',
	'colls' => 'columnas',
	'colls_cfg_desc' => 'Columnas',
	'comment' => 'Comentario',
	'comment_add' => 'Añadir comentario',
	'comment_add_err' => 'Ha habido un error al intentar añadir el comentario',
	'comment_added' => 'El comentario ha sido añadido',
	'comment_err_noselect' => 'Please select any comment',
	'comment_suc_approved' => 'Approval is succeeded',
	'comment_suc_hide' => 'Comment is now hidden',
	'comment_suc_unhide' => 'Comment is now visible',
	'comment_suc_update' => 'Update success',
	'comments' => 'Comentarios',
	'comments_all_title' => 'Todos los comentarios',
	'comments_cnt' => 'contador de comentarios',
	'comments_hidden_title' => 'Comentarios ocultos',
	'comments_row' => 'Fila de comentarios',
	...
	'config_update_suc' => 'Config has been updated',
	'copy' => 'Copiar',
	'credit_lang_file' => 'Cr&eacute;dito de archivo de idioma',
	'credit_lang_file_author' => 'risingisland',
	'credit_lang_file_date' => '23 de junio, 2010',
	...
	'crumbs_showAsLinks_cfg_desc' => 'Show the folders&#039; crumbs as hyperlinks',
	'crumbs_showCurrent_cfg' => 'Show the current crumb',
	'crumbs_showCurrent_cfg_desc' => 'Show the current gallery',
	'crumbs_showHome_cfg' => 'Home crumb',
	'crumbs_showHome_cfg_desc' => 'Show the crumbs from the root gallery',
	'crumbs_showPrevious_cfg' => 'Show the previous crumb',
	'crumbs_showPrevious_cfg_desc' => '&lt;p&gt;Show the previous crumbs until the direct child of the root gallery&lt;/p&gt;',
	'crumbs_usage_cfg_desc' => 'Migas utilizará el texto seleccionado. Si una de las carpetas Alias está vacía, automáticamente usará su nombre en su lugar. ',
	'css' => 'CSS',
	'custom' => 'Custom',
	'dashboard' => 'Dashboard',
	'database' => 'Database',
	...
	'dir' => 'Carpeta',
	'dir_add_err' => 'Ha habido un error al intentar crear la carpeta',
	'dir_added' => 'La carpeta ha sido creada',
	'dir_cfg_desc' => '&lt;p&gt;Ruta de acceso a la carpeta &lt;strong class=&quot;warning&quot;&gt;con barra final&lt;/strong&gt;, por ejemplo: assets/easy2gallery /.&lt;/p&gt;',
	'dir_create' => 'Crear carpeta',
	'dir_create_err' => 'No se puede crear la carpeta',
	'dir_created' => 'carpeta creada',
	'dir_db_notexists_err' => 'Parent folder does not exist in database',
	'dir_delete_err' => 'No se puede borrar la carpeta',
	'dir_delete_fdb' => 'Carpeta borrado s&oacute;lo del DB',
	...
	'dir_hiddennot_suc' => 'Folder is now visible',
	'dir_move_err' => 'No se puede mover la carpeta',
	'dir_move_suc' => 'Relocalizar carpeta',
	'dir_moved' => 'carpeta relocalizada',
	'dir_moved_fdb' => 'Carpeta actualizada s&oacute;lo del DB',
	'dir_moved_fhdd' => 'carpeta relocalizada s&oacute;lo en HD',
	...
	'dirs_deleted_fhdd' => 'carpetas eliminadas de HD',
	'dirs_hidden_suc' => 'folders are now hidden',
	'dirs_hiddennot_suc' => 'folders are now visible',
	'dirs_move_err' => 'Could not move folders',
	'dirs_move_suc' => 'Moved folders',
	'dirs_moved' => 'folders have been moved',
	'dirs_moved_fdb' => 'carpetas actualizada en DB',
	'dirs_moved_fhdd' => 'carpetas relocalizadas en HD',
	'dirs_uploaded' => 'carpetas actualizada',
	'disabled' => 'disabled',
	'disk_space_left' => 'Diskspace left',
	'download' => 'Descargar',
	'dpath_err' => 'ruta o identificador de la carpeta no est&aacute; definido',
	'e2g_debug' => 'Opci&oacute;n de debug ',
	'e2g_debug_cfg_desc' => 'Modo de debug.',
	'e2g_encode' => 'Codificaci&oacute;n',
	'e2g_encode_cfg_desc' => 'Codificaci&oacute;n de scripto.',
	'e2g_wrapper_cfg' => 'Gallery&#039;s div wrapper ID',
	'e2g_wrapper_cfg_desc' => '&lt;p&gt;The &amp;lt;div id=&quot;[string]&quot;&amp;gt; value of all the gallery&#039;s wrappers&lt;/p&gt;',
	'ecl' => 'Comentarios por p&aacute;gina',
	'ecl_cfg_desc' => 'Comentarios por p&aacute;gina',
	'ecl_page' => 'Comentarios por p&aacute;gina p&aacute;gina de destino',
	'edit' => 'Editar',
	'editing' => 'Informaci&oacute;n de edicion',
	'email' => 'Email',
	'empty' => 'vac&iacute;o',
	'enable' => 'Permitir',
	'enabled' => 'Habilitado',
	'enter_dirname' => 'Escriba el nombre de la nueva carpeta',
	'enter_new_alias' => 'T&iacute;tulo de carpeta',
	'enter_new_dirname' => 'Renombrar carpeta',
	'err_empty_alias' => 'Please type the alias',
	'err_empty_id' => 'Unexpected missing ID',
	'err_empty_name' => 'Please type the name',
	'err_undefined' => 'Undefined error',
	'events_system' => 'System Events',
	'extension_valid' => 'Extensiones v&aacute;lidos ',
	'file' => 'Archivo',
	'file_add_err' => 'No se pudo a&ntilde;adir el archivo',
	'file_added' => 'Archivo a&ntilde;adido',
	'file_create_err' => 'Could not create file',
	'file_delete' => 'archivo borrado',
	'file_delete_err' => 'No se pudo eliminar el archivo',
	'file_delete_fdb' => 'archivo eliminado s&oacute;lo de DB',
	'file_delete_fhdd' => 'archivo eliminado s&oacute;lo de HD',
	'file_exists' => 'archivo existe',
	'file_hidden_inverse_err' => 'File has already been hidden',
	'file_hidden_suc' => 'File has been hidden',
	'file_hiddennot_inverse_err' => 'File has already visible',
	'file_hiddennot_suc' => 'File is now visible',
	'file_move_err' => 'No se pudo mover el archivo',
	'file_rename' => 'Cambiar el nombre de archivo',
	'file_rename_err' => 'No se pudo cambiar el nombre de archivo',
	'file_to_same_dir_err' => 'No se pudo mover el archivo en la misma carpeta',
	...
	'files_hidden_suc' => 'files are now hidden',
	'files_hiddennot_suc' => 'files are now visible',
	'files_move_err' => 'Could not move files',
	'files_moved' => 'files have been moved',
	...
	'fpath_err' => 'ruta o identificador de la imagen no est&aacute; definido',
	'gal_desc' => 'Gallery description',
	'gal_desc_cfg_desc' => 'Turn on the gallery description',
	'gal_desc_continuous' => 'Continuous description',
	'gal_desc_continuous_cfg_desc' => 'Gallery description continues through gallery pagination',
	'gallery' => 'Galer&iacute;a',
	'gallery_folder' => 'Carpetas de galer&iacute;a',
	'gallery_groups' => 'Grupos de galer&iacute;a',
	'general' => 'General',
	'generated' => 'generado',
	'glib' => 'Biblioteca JS',
	'glib_cfg_desc' => 'Biblioteca gr&aacute;fica',
	'go' => 'ir',
	'go_there' => 'ir all&aacute;',
	'gotofolder' => 'Ir a la carpeta',
	'grid' => 'Cuadr&iacute;cula',
	'grid_cfg_desc' => 'Cuadr&iacute;cula de miniaturas.',
	'grid_class' => 'Cuadr&iacute;cula de clases',
	'grid_class_cfg_desc' => 'Nombre de clase de CSS de la cuadr&iacute;cula.',
	'h' => 'Altura',
	'h_cfg_desc' => '&lt;p&gt;Altura m&aacute;xima en p&iacute;xeles, im&aacute;genes m&aacute;s grandes ser&aacute;n redimensionadas autom&aacute;ticamente.&lt;strong&gt;&lt;br /&gt;0 - sin l&iacute;mite&lt;/strong&gt;.&lt;/p&gt;',
	'h_thumb_cfg_desc' => 'Altura de Miniatura, px',
	'header' => 'Cabecera',
	'help' => 'Ayuda',
	...
	'help_moreinfo_title' => 'M&aacute;s informaci&oacute;n',
	...
	&lt;ul&gt;
	&lt;li&gt; default : `1` - &lt;strong&gt;root&lt;/strong&gt;&lt;/li&gt;
	&lt;li&gt;special : `*` (star symbol) - &lt;strong&gt;everything&lt;/strong&gt;&lt;/li&gt;
	&lt;/ul&gt;
	...
	&lt;p&gt;&lt;strong&gt;&amp;amp;where_dir&lt;/strong&gt; - additional clause(s) into the directory&#039;s query&lt;/p&gt;
	&lt;p&gt;&lt;strong&gt;&amp;amp;where_file&lt;/strong&gt; - additional clause(s) into the image&#039;s query&lt;/p&gt;
	&lt;p&gt;Usage:&lt;/p&gt;
	&lt;ul&gt;
	...
	&lt;/ul&gt;
	&lt;/li&gt;
	&lt;li&gt;Example:&lt;br /&gt;[!easy2? &amp;amp;gid=`2` &amp;amp;where_file=`id, less, 50 AND size, less, &#039;15000&#039; OR size, greater, &#039;90000&#039; OR name,equal,&#039;ANDROMEDA&#039; OR name, equal, &#039;BORG&#039;`!]&lt;/li&gt;
	&lt;/ul&gt;
	...
	&lt;ul&gt;
	&lt;li&gt;The watermark&lt;/li&gt;
	&lt;li&gt;&lt;strong&gt;&amp;amp;lp_w&lt;/strong&gt; - landingpage width box, default: will be retrieved from the original size&lt;/li&gt;
	&lt;li&gt;&lt;strong&gt;&amp;amp;lp_h&lt;/strong&gt; - landingpage height box, default: will be retrieved from the original size&lt;/li&gt;
	...
	'help_params_title' => 'Par&aacute;metros',
	'help_plugins_content' => '&lt;h2&gt;Plugin parameters&lt;/h2&gt;
	&lt;p&gt;&lt;strong&gt;&amp;amp;plugin=`thumb: pluginName1#prerender, pluginName2 | gallery: pluginName3, pluginName4@custom/index/file.php | landingpage: pluginName5`&lt;/strong&gt;&lt;/p&gt;
	...
	&lt;p&gt;The # (hash) symbol is to targeting the &#039;prerender&#039; or &#039;render&#039; on event process.&lt;/p&gt;',
	...
	'help_tpl_title' => 'Plantillas',
	'hidden' => 'Ocultado',
	'hide' => 'Ocultar',
	'hide_not' => 'Mostrar',
	'id_err' => 'mal Id',
	'ie6_allow_cfg' => 'Redirect IE6',
	'ie6_allow_cfg_desc' => '&lt;p&gt;Redirect Internet Explorer 6 users to the other browsers&#039; homepages&lt;/p&gt;',
	'ignore' => 'Ignorado',
	'image' => 'imagen',
	'img_old_resize' => 'Cambiar tama&ntilde;o de im&aacute;genes existentes',
	...
	'img_orientation_follow' => 'Follow orientation (switch w/h)',
	'img_orientation_follow_cfg_desc' => '&lt;p&gt;The images will be resized by comparing the w/h ratio with their orientations (portrait/landscape)&lt;/p&gt;',
	'img_src_cfg' => 'Image source',
	'img_src_cfg_desc' => '&lt;p&gt;Watermarked images will be created under the `generated` option&lt;/p&gt;',
	'index_file' => 'Index file',
	'indexfile' => '&lt;h2&gt;Unauthorized access&lt;/h2&gt;
	&lt;p&gt;You&#039;re not allowed to access file folder&lt;/p&gt;',
	'info' => 'Info',
	'info_gallery' => 'Informaci&oacute;n de galer&iacute;a',
	'info_system' => 'Informaci&oacute;n de sistema',
	'inner' => 'interior',
	'install' => 'Instalar',
	'invalid_file' => 'File path&#039;s is invalid',
	'invalid_folder' => 'Folder path&#039;s is invalid',
	'invalid_uid' => 'User id is invalid',
	'invisible' => 'Invisible',
	'invoke_event_err' => 'Error when invoking an event',
	'ip_address' => 'Direcci&oacute;n IP',
	'ip_ignored_suc' => 'Este IP ha sido ignorado',
	'ip_ignored_title' => 'Direcci&oacute;nes IP ignorados',
	'ip_unignored_suc' => 'Esta IP ya no se ignora.',
	...
	'js_duplicate_slideshow_confirm' => 'Are you sure you want to duplicate this slideshow?\n\nClick ok to confirm.',
	'js_duplicate_viewer_confirm' => 'Are you sure you want to duplicate this viewer?\n\nClick ok to confirm.',
	...
	'langfile_updated' => 'Archivo de idioma se actualiza.',
	'last_modified' => 'edici&oacute;n de la fecha',
	'left' => 'izquierda',
	'limit' => 'Im&aacute;genes por p&aacute;gina',
	'limit_cfg_desc' => 'Miniaturas por p&aacute;gina',
	'list' => 'Listado',
	'magic_quote' => 'Magic Quotes',
	'magic_quote_disabling' => 'Try to disable it from .htaccess or php.ini',
	'megabytes' => 'MB',
	'memory_usage' => 'uso de la memoria',
	'mgr_comments' => 'Gestor de comentarios',
	'mgr_files' => 'Gestor de archivos',
	'mgr_plugins' => 'Gestor de plugins',
	'mgr_users' => 'Gestor de usuarios',
	'miscellaneous' => 'Miscellaneous',
	'mod_date_format' => 'Formato de fecha',
	...
	'name' => 'Nombre',
	'name_len' => 'm&aacute;ximo longitud del nombre de la miniatura',
	'name_len_cfg_desc' => 'M&aacute;ximo longitud del nombre',
	'nav_nextSymbol_cfg' => 'Text or image tag',
	...
	'on' => 'Activado',
	'options' => 'Acciones',
	'order' => 'Miniaturas ordenadas por',
	'order2' => 'Carpetas ordenadas por',
	'order2_cfg_desc' => 'M&eacute;todo de clasificaci&oacute;n de carpetas',
	'order_cfg_desc' => 'M&eacute;todo de clasificaci&oacute;n',
	'original' => 'original',
	...
	'plugin_update_err' => 'Could not update plugin',
	'plugin_update_suc' => 'Updated the plugin',
	'plugins' => 'Plugins',
	'plugins_desc' => '&lt;p&gt;These plugins are applied as the default behaviour. Any different settings can be set from:&lt;/p&gt;
	&lt;ul&gt;
	&lt;li&gt;Snippet call parameters on the runtime. Please read the Help tab for more information.&lt;/li&gt;
	&lt;li&gt;Directory / file edit page&lt;/li&gt;
	&lt;/ul&gt;',
	'post' => 'A&ntilde;adir',
	'random' => 'sin orden',
	'recaptcha' => 'recaptcha',
	'recaptcha_key_private' => 'Llave privada',
	'recaptcha_key_private_desc' => 'Se utiliza cuando la comunicaci&oacute;n entre el servidor y el servidor de reCAPTCHA. Aseg&uacute;rese de mantener en secreto.',
	'recaptcha_key_public' => 'Llave p&uacute;blica',
	'recaptcha_key_public_desc' => 'Esto se utiliza en el c&oacute;digo JavaScript que se sirve a sus usuarios',
	...
	'reset' => 'Reinicializar',
	'reset_all_hit_suc' => 'Todos los impactos se han restablecido',
	'resize' => 'cambiar el tama&ntilde;o',
	'resize_type' => 'Cambiar el tama&ntilde;o Miniatura',
	'resize_type_cfg_desc' => '&lt;p&gt;Interior: recortada | Reducir: reducir | Cambiar el tama&ntilde;o: ajuste autom&aacute;tico proporcional&lt;/p&gt;',
	'restore_err' => 'Se ha producido un error al intentar de restaurar',
	'restore_suc' => 'nombres galer&iacute;as restauradas',
	'right' => 'derecho',
	'save' => 'Guardar',
	'search' => 'Buscar',
	'select_all' => 'Seleccionar todos',
	'select_dirfile' => 'Por favor, seleccione un directorio o imagen',
	'select_newdir' => 'Selecciona el nuevo destino del directorio',
	'server' => 'Servidor',
	'setlocale' => 'setlocale( LC_ALL ,&#039;es_ES.utf8&#039; )',
	'settings' => 'Configuraci&oacute;n',
	'settings_crumbs' => 'Configuraci&oacute;n de migas',
	'settings_display' => 'Ajustes de la pantalla',
	'settings_img' => 'Ajustes de im&aacute;genes',
	'settings_nav_prevUpNext' => 'Previous/Up/Next Navigation',
	'settings_pagination' => 'Paginaci&oacute;n',
	'settings_recaptcha' => 'Configuraci&oacute;n de reCaptcha',
	'settings_slideshow' => 'Diapositivas',
	'settings_template_files' => 'Template Files',
	'settings_thumb' => 'Ajustes de miniatura',
	'show' => 'Show',
	'shrink' => 'reducir',
	'size' => 'Tama&ntilde;o',
	'slideshow_add_err' => 'Could not add slideshow',
	'slideshow_add_suc' => 'Added new slideshow',
	...
	'ss_rgb_cfg_desc' => 'White is 255 255 255, black is 0 0 0.',
	...
	'stay_here' => 'quedarme aqu&iacute;',
	'strip_html_tags_cfg' => 'Stip HTML Tags',
	'strip_html_tags_cfg_desc' => 'Strip HTML tags for the text/description output',
	'submit' => 'Guardar',
	'summary' => 'Resumen',
	'synchro' => 'Sincronizar',
	'synchro_err' => 'Se ha producido un error al intentar sincronizar',
	'synchro_suc' => 'Galer&iacute;a sincronizada',
	'table' => 'tabla',
	'tag' => 'Etiqueta',
	'tag_err_exist' => 'Etiqueta existe',
	'tag_err_noexist' => 'Etiqueta no existe',
	'tag_err_novalue' => 'Por favor, escriba la nueva etiqueta',
	'tag_suc_new' => 'Nueva etiqueta se aplica',
	'tag_suc_remove' => 'Old tag was removed',
	'text' => 'texto',
	'thbg_rgb' => 'Color de fondo de miniatura',
	'thbg_rgb_cfg_desc' => '&lt;p&gt;Blanco es 255 255 255, Negro es 0 0 0. It&#039;s only resized thumbnail that contains margin gap with default thumb size.&lt;/p&gt;',
	'theme' => 'Plantilla',
	...
	'thq' => 'Nivel de compresi&oacute;n',
	'thq_cfg_desc' => 'Nivel de compresi&oacute;n de miniaturas JPEG , de 0 a 100%.',
	'thumb' => 'miniatura',
	'thumbnails' => 'Miniaturas',
	'tinymce_path' => 'Ruta de Tiny MCE',
	'tinymce_path_desc' => 'Ruta a tiny_mce.js',
	'title' => 'T&iacute;tulo',
	'tofolder' => 'a carpeta',
	'top' => 'Arriba',
	'tpl' => 'Plantillas',
	'tpl_comments_cfg_desc' => '&lt;p&gt;nombre de trozos o ruta de  archivo, &lt;strong class=&quot;warning&quot;&gt; relativo a comments.easy2gallery.php&lt;/strong&gt;&lt;/p&gt;',
	'tpl_css_path_cfg_desc' => 'Ruta de CSS',
	'tpl_jsdisabled' => 'JS disabled tpl',
	'tpl_lp' => 'P&aacute;gina de destino tpl',
	'tpl_lp_cmt' => 'Comentarios p&aacute;gina de destino tpl',
	'tpl_lp_cmt_path_cfg_desc' => 'Nombre de trozo o ruta de acceso al archivo tpl de p&aacute;gina de destino comentarios',
	'tpl_lp_cmt_row' => 'Fila de comentarios de p&aacute;gina de destino tpl',
	'tpl_lp_css' => 'P&aacute;gina de destino CSS',
	'tpl_lp_path_cfg_desc' => '&lt;p&gt;nombre de trozos o ruta de acceso de la plantilla de p&aacute;gina de destino &uacute;nico&lt;/p&gt;',
	'tpl_path_cfg_desc' => 'Nombre de trozo o ruta de acceso al archivo tpl',
	'tpl_slideshow' => 'Slideshow tpl',
	'translation' => 'Traducci&oacute;n',
	'type' => 'Tipo',
	'type_err' => 'Restringidos tipo de archivo',
	'uim_preview' => 'Vista Previa',
	'uim_preview_err' => 'Vista Previa&lt;br /&gt;no disponible',
	'unignore' => 'No se ignora',
	'unzip_dir_err' => 'Unable to unzip folder',
	'unzip_file_err' => 'Unable to unzip file',
	'update' => 'Actualizar',
	'update_err' => 'cambios no se guardaron',
	'updated' => 'guardado',
	'upload' => 'Cargar',
	'upload_dir' => 'Cargar la imagen en la carpeta',
	'upload_empty' => 'No file was selected',
	'upload_err' => 'No se pudo cargar el archivo',
	'upload_image' => 'Subida de im&aacute;genes',
	'upload_limit' => 'Filesize limit',
	...
	'user_mgr_groups' => 'Manager Groups',
	'user_mgr_groups_desc' => '&lt;p&gt;The relation among manager users, manager groups, and manager pages (location)&lt;/p&gt;',
	'user_mgr_synchro_err' => 'Error on synchronizing Manager users',
	'user_mgr_synchro_suc' => 'Manager User groups have been synchronized',
	'user_page_desc' => '&lt;p&gt;These names are set from the MODx&#039;s Security Permissions. Click the Synchronize button below to synchronize with MODx&#039;s users.&lt;/p&gt;',
	'user_permissions' => 'Permissions',
	'user_roles' => 'Roles',
	'user_update_err' => 'Error on updating users',
	'user_update_suc' => 'User group was updated',
	'user_web_access' => 'Web Access',
	'user_web_groups' => 'Web Groups',
	'user_web_groups_desc' => '&lt;p&gt;The relation among web users, member groups, and picture groups (location)&lt;/p&gt;',
	'user_web_synchro_err' => 'Error on synchronizing Web users',
	'user_web_synchro_suc' => 'Web User groups have been synchronized',
	'users' => 'Users',
	'users_mgr_roles' => 'Manager User&#039;s Roles',
	'utilities' => 'Utilities',
	...
	'viewer_action_desc_glib' => '&lt;p&gt;Code to trigger javascript&#039;s onclick action on image&#039;s hyperlinks.&lt;br /&gt;Available placeholders:&lt;/p&gt;
	&lt;ul&gt;
	...
	'viewer_autoload' => 'auto load',
	'viewer_desc_alias' => 'for module&#039;s option',
	'viewer_desc_autoload' => '&lt;p&gt;check this for auto load, or uncheck this if they are included manually into templates&lt;/p&gt;',
	'viewer_desc_headers' => '&lt;p&gt;register the CSS/JS files into HTML&#039;s header, separated by &quot;|&quot; (pipe symbol) for multiple files/hrefs&lt;/p&gt;',
	'viewer_desc_html_headers' => '&lt;p&gt;register the hardcoded &amp;lt;script&amp;gt; headers into HTML&#039;s header&lt;/p&gt;',
	'viewer_desc_name' => 'for snippet&#039;s parameter',
	'viewer_disabled' => 'Viewer disabled',
	'viewer_headers' => 'headers',
	'viewer_update_err' => 'Could not update the viewer',
	'viewer_update_suc' => 'Updated the viewer',
	'visible' => 'Visible',
	'w' => 'Ancho',
	'w_cfg_desc' => '&lt;p&gt;Anchura m&aacute;xima en p&iacute;xeles, las im&aacute;genes m&aacute;s grandes ser&aacute;n redimensionadas autom&aacute;ticamente.&lt;strong&gt;&lt;br /&gt;0 - sin limite&lt;/strong&gt;.&lt;/p&gt;',
	'w_thumb_cfg_desc' => 'Ancho de miniatura, px.',
	'watermark_horpos' => 'Posici&oacute;n horizontal',
	'watermark_horpos_cfg_desc' => 'posici&oacute;n horisontal de la marca de agua',
	'watermark_text_path_cfg_desc' => 'texto de marca de agua o ruta',
	'watermark_textpath' => 'texto/ruta',
	'watermark_type_cfg_desc' => 'tipo de marca de agua, texto o imagen',
	'watermark_verpos' => 'Posici&oacute;n vertical',
	'watermark_verpos_cfg_desc' => 'posici&oacute;n vertical de marca de agua',
	...
	'yes' => 'si',
	'zip' => 'Zip',
	'zip_create_err' => 'No se puede crear el archivo zip',
	'zip_create_suc' => 'Zip file was created',
	'zip_open_err' => 'incapaz de crear el archivo zip',
	'zip_select_none' => 'Por favor, seleccione un directorio o archivo de descarga',
);