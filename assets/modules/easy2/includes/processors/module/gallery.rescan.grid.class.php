    ...
    public function process() {
        ...
        if (FALSE !== $scanDirs):
            ...
            foreach ($scanDirs as $scanDir) {
                ...
                $dirHref = '';
                $dirIcon = '
                <i class="icon-custom icon-no-border icon-color-yellow fa fa-folder icon-vs" title="' . $this->modx->e2gMod->lng['dir'] . '"></i>
                ';
            ...
            if (isset($mdirs) && count($mdirs) > 0) {
                foreach ($mdirs as $v) {
                    ...
                    $deletedDirIcon = '
						<i class="icon-custom bordered-2x icon-bg-red fa fa-trash icon-vs" title="' . $this->modx->e2gMod->lng['deleted'] . '"></i>
                    ';
        ...
        if (FALSE !== $scanFiles):
            ...
            foreach ($scanFiles as $scanFile) {
                ...
                ';
                    ...
                    $fileId = NULL;
                    $fileIcon = '
						<i class="icon-custom icon-no-border icon-bg-green fa fa-plus-circle fa-2x icon-vs"></i>
                ';
                    $fileAttributeIcons = '';
                    // add file
