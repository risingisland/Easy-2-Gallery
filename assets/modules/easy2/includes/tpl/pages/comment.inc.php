                    ...
                    <td valign="top">
                        <form name="listComments" action="" method="post">
                            ...
                            <?php
                                    ...
                                    $queryComments = mysqli_query($this->modx->db->conn,$selectComments);
                                    if (!$queryComments)
                                        die(mysql_error());
                                    ...
                                    while ($l = mysqli_fetch_assoc($queryComments)) {
                            ...
                            ?>
                                    ...
                                    <?php } ?>
                                        <a href="<?php echo $this->e2gModCfg['index'] . $filtered; ?>&amp;page=comments&amp;file_id=<?php echo $l['file_id']; ?>&amp;pid=<?php echo $l['dir_id']; ?>">
                                            <i class="icon-custom bordered-2x icon-bg-blue fa fa-comments icon-vs" title="<?php echo $this->lng['comments']; ?>"></i>
                                        </a>
                                        <a href="<?php echo $filesLink; ?>&amp;page=edit_file&amp;file_id=<?php echo $l['file_id']; ?>&amp;pid=<?php echo $l['dir_id']; ?>">
                                            <i class="icon-custom bordered-2x icon-bg-orange fa fa-pencil icon-vs" title="<?php echo $this->lng['edit']; ?>"></i>
                                        </a>
                                        <b>
                                    ...
                                    <div>
                                        ...
                                        ?>"
                                                onclick="return unignoreIPAddress();">
                                                 <i class="icon-custom icon-no-border icon-bg-green fa fa-flag fa-2x icon-vs" title="<?php echo $this->lng['unignore']; ?>"></i>
                                             </a>
                                        <?php } else {
                                        ?>
                                                <a href="<?php
                                        ...
                                        ?>"
                                                onclick="return ignoreIPAddress();">
                                                 <i class="icon-custom icon-no-border icon-bg-red fa fa-flag fa-2x icon-vs" title="<?php echo $this->lng['ignore']; ?>"></i>
                                             </a>
                                        <?php } ?> )
                                        </div>
                                        <hr />
