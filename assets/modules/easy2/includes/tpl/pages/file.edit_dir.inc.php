...
$queryDir = mysqli_query($this->modx->db->conn,'SELECT * FROM ' . $this->modx->db->config['table_prefix'] . 'easy2_dirs WHERE cat_id=' . (int) $this->sanitizedGets['dir_id']);
$row = mysqli_fetch_assoc($queryDir);
