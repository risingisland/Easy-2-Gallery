...
?>
<form action="<?php echo $this->e2gModCfg['index']; ?>&amp;act=save_config" method="post" style="padding-left:20px;">
    ...
    <input type="submit" value="<?php echo $this->lng['save']; ?>" class="btn btn-success" /> &nbsp; &nbsp; &nbsp;
    <input name="clean_cache" type="checkbox" value="1" class="checkbox" /> <?php echo $this->lng['clean_cache']; ?>
    <br /><br />
...
<!-- 1.5.0-rc3
removed tinymce, something was not working right
                <tr class="gridAltItem">
